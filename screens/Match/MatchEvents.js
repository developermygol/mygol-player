  ...
  class MatchEventClass extends Component {
    handlePlayerPress = (player, idTeam) => {
      ...
      p.navigation.push('PlayerDetails', {
        idPlayer: player.id,
        idUser: player.userData.id,
        idTeam: idTeam,
        idTournament: this.props.match.idTournament,
      });
    };
    ...
    getEventImage = eventType => {
      ...
      switch (eventType) {
        ...
        default:
          return <Text style={style.EventIcon}>{this.getEventText(eventType)}</Text>;
      }
    };
