...
class PersonalData extends Component {
    ...
    getFormOptions = () => {
        ...
        return {
            fields: {
                name: { label: Localize('EnName'), error: Localize('EnName.Validation'), placeholder: Localize('EnName.PlaceHolder'), editable },
                ...
                password: { label: Localize('EnPassword'), error: Localize('EnPassword.Validation'), placeholder: Localize('EnPassword.PlaceHolder'), autoCapitalize: 'none' }
            }
        };
    }
        ...
        return (
            <KeyboardAvoidingView behavior='padding' style={{flex: 1}}>
                <ScrollView style={GlobalStyles.MainView} contentContainerStyle={style.ContainerView}>
                    ...
                    <Text style={style.Intro}><Loc>{this.data.approved ? 'PersonalData.Intro.Approved' : 'PersonalData.Intro'}</Loc></Text>
                        <Form
                            ref={c => this.form = c}
                            type={this.getForm()}
                        ...
                        />
                        <SpinnerButton title={buttonCaption} onPress={this.handleNextButton} style={gStyles.NextButton} loading={store.loading} />
                    </View>
                </ScrollView>
