            ...
            <KeyboardAvoidingView behavior='padding' style={{flex: 1}}>
                <ScrollView contentContainerStyle={style.ContainerView}>
                    <View style={GlobalStyles.MainView}>
                        <Text style={style.Intro}><Loc>SocialData.Intro</Loc></Text>
                        <AttachImage style={style.ProfilePicture} image={this.data ? getUploadsIcon(this.data.userData.avatarImgUrl, this.data.userData.id, 'user') : null}  label='SoProfilePicture' aspect={[1, 1]} imageSize={{width: 160, height: 160}} ref={c => this.capture = c} />
                        <Form
                            ref={c => this.form = c}
