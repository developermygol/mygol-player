...
class MainPhoto extends Component {
  ...
  handleNextButton = async () => {
    ...
    try {
      ...
      else this.props.navigation.navigate('IdScan');
    } finally {
      this.loading = false;
    }
  };
      ...
      <View style={gStyles.MainView}>
        <View style={gStyles.vcenter1}>
          <Text style={style.Intro}>
            <Loc>{isEditing ? 'MainPhoto.Edit' : 'MainPhoto.Intro'}</Loc>
          </Text>
        </View>
        <View style={gStyles.vcenter1}>
          <Text style={style.Details}>
            <Loc>MainPhoto.Details</Loc>
          </Text>
        </View>
        <AttachImage
          cameraOnly
        ...
        />
        <View style={gStyles.vcenter1}>
          <Text style={style.AdditionalText}>
            <Loc>MainPhoto.AdditionalText</Loc>
          </Text>
        </View>
        <SpinnerButton
          title={isEditing ? 'Save' : 'Next'}
